...
### Added: Closed-loop prompt improvement — prompt deployments, remediation context on evals, and regression detection

Control Loop v1.5 ships three related surfaces:
...
See the [migration guide](/control-loop/migration-from-v1) for defaults that apply to existing policies and projects.
