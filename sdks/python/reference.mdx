...
This page documents the public surface of `trulayer`. For narrative usage, see the [tutorial](/sdks/python/tutorial). For configuration details, see [configuration](/sdks/python/configuration). For runnable end-to-end demos, see [examples](/sdks/python/examples).

## Source and issues

- **Source:** [github.com/trulayer/client-python](https://github.com/trulayer/client-python)
- **Issues / bug reports:** [github.com/trulayer/client-python/issues](https://github.com/trulayer/client-python/issues)
- **Package:** [`trulayer` on PyPI](https://pypi.org/project/trulayer/)
