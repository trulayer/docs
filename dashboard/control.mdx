...
![screenshot: Control overview with active policies](../images/dashboard-control-overview.png)
...
![screenshot: Policy form with trigger and action](../images/dashboard-control-policy-form.png)
...
![screenshot: Kill-switch confirmation modal](../images/dashboard-control-kill-switch.png)
...
![screenshot: HITL queue with pending approvals](../images/dashboard-control-hitl.png)
...
Only users with role `operator` or `owner` can approve/reject. See [Team settings](./settings-team) for roles.
