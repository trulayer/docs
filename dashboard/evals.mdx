...
Row caps are per plan: 100 for Starter, 5,000 for Pro/Team/Business. If the export hits the cap, a toast appears indicating how many rows were returned and suggests either tighter filters or a plan upgrade.
