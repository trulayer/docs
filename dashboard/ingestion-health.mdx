...
DLQ replay (re-ingesting parked spans after you fix the root cause) requires the **Operator** role or higher. The replay control isn't shipped yet; for now, contact support if you need spans reprocessed.
