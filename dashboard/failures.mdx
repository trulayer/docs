...
![screenshot: Failures overview with cluster list](../images/dashboard-failures-overview.png)
...
![screenshot: Failure cluster root-cause view](../images/dashboard-failures-cluster-detail.png)
...
![screenshot: Alert rule creation form](../images/dashboard-failures-alert-rule.png)
